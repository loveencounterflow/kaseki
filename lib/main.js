(function() {
  ...
  Git = class Git extends Kaseki {
    ...
    status() {
      ...
      //.......................................................................................................
      if ((match = head.match(/^## No commits yet on (?<local_branch>.*?)$/)) != null) {
        R.local_branch = match.groups.local_branch;
      //.......................................................................................................
      } else if ((match = head.match(/^##\s+(?<local_branch>.*?)\.\.\.(?<remote_branch>\S+).*$/)) != null) {
        R.local_branch = match.groups.local_branch;
        R.remote_branch = match.groups.remote_branch;
      //.......................................................................................................
      } else if ((match = head.match(/^##\s+(?<local_branch>.*?)$/)) != null) {
        R.local_branch = match.groups.local_branch;
      }
      //.......................................................................................................
      if ((match = head.match(/\[.*ahead (?<ahead_count>\d+).*\]$/)) != null) {
        R.ahead_count = parseInt(match.groups.ahead_count, 10);
      }
      //.......................................................................................................
      if ((match = head.match(/\[.*behind (?<behind_count>\d+).*\]$/)) != null) {
